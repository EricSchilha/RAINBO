...
#define ADQ1		0b00000000	// Phototransistor Q1 A-D channel input (Ch0)
#define	AN1 		0b00000100	// Temperature sensor T1 A-D input (Ch1)
#define	ADT1		0b00000100	// Temperature sensor T1 A-D input (Ch1)
#define AN3			0b00001100	// Unused A-D channel 3 input on N2 header
#define ADTIM		0b01110100	// PICmicro on-die temperature indicator module
#define ADDAC       0b01111000  // DAC output
#define ADFVR       0b01111100  // Fixed voltage reference output
